...
import cardData from "./SpeacialFood.json"
...
const SpeacialFood = () => {
  ...
  <h1 className="text-center" style={{ fontSize: "50px", fontWeight: "600" }}>
    Today <span className="text-[#cb3939]">Special</span> offers
  </h1>
  <p className="text-center text-gray-400 mx-auto" style={{ maxWidth: "70ch" }}>
    Lorem Ipsum Is Simply Dummy Text Of The Printing And Typesetting Industry. Lorem Ipsum Has Been The Industry{"'"}s Standard Dummy Text Ever Since The 1500s.
  </p>
</div>

<div className="grid gap-12 px-12 grid-cols-1 mt-6 md:grid-cols-2 lg:grid-cols-4 md:gap-y-12 items-center mx-auto max-w-[1280px] lg:justify-center">
